...
public class GuiAdvancedSettings extends SettingPanel<TabbySettings> {
    ...
    @Override
    public void initGUI() {
        add(new GuiLabel(new TranslationTextComponent(ADVANCED_FADE_TIME)), new int[]{1, 1});
...
//        addComponent(gsi, new int[]{5, 3, 2, 1});
        ...
        add(new GuiLabel(new TranslationTextComponent(ADVANCED_CHAT_VISIBILITY)), new int[]{1, 3});
        add(new GuiSettingEnum<>(getSettings().advanced.visibility, LocalVisibility.values()), new int[]{5, 3, 3, 1});

        add(new GuiLabel(new TranslationTextComponent(ADVANCED_HIDE_DELIMS)), new int[]{2, 5});
        add(new GuiSettingBoolean(getSettings().advanced.hideTag), new int[]{1, 5});

        add(new GuiLabel(new TranslationTextComponent(ADVANCED_SPELLCHECK)), new int[]{2, 6});
        add(new GuiSettingBoolean(getSettings().advanced.spelling), new int[]{1, 6});

        add(new GuiLabel(new TranslationTextComponent(EXPERIMENTAL)), new int[]{0, 13});
    }
